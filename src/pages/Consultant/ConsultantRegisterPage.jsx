...
const ConsultantRegisterPage = () => {
  ...
  const validateForm = () => {
    ...
    if (form.experienceYears === "" || isNaN(form.experienceYears))
  ...
  return (
    <AuthLayout
      title="Đăng ký Tư vấn viên"
      subtitle="Tham gia đội ngũ tư vấn viên của HealthCare+"
    >
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex items-center">
          <input
            name="isCycleTrackingOn"
            type="checkbox"
            checked={form.isCycleTrackingOn}
            onChange={handleChange}
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full py-3 mt-2 bg-blue-600 text-white font-semibold rounded-lg shadow hover:bg-blue-700 transition duration-200 disabled:opacity-60"
        >
